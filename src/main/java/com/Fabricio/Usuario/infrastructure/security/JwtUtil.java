package com.Fabricio.Usuario.infrastructure.security;
...
public class JwtUtil {
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60)) // Define a data e hora de expiração (1 hora a partir da emissão)
